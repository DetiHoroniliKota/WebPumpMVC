...
public static class SeedData
{
    public static void Initialize(IServiceProvider serviceProvider)
    {
                ...
                DbContextOptions<WebPumpMVCContext>>()))
        {
            ...
            var pumps = new Pump[]
            {
            new Pump {Title = "TF3 40",H = 40,Q = 3,Price = 9752, Typ = "downhole"},
            new Pump {Title = "TF3-60",H = 60,Q = 3,Price = 50000, Typ = "downhole"},
            new Pump {Title = "TF3-80",H = 80,Q = 3,Price = 50000, Typ = "downhole"},
            new Pump {Title = "TF3-110",H = 110,Q = 3,Price = 50000, Typ = "downhole"}
            };
